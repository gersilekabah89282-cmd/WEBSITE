        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16">
          ...
          <div className="lg:col-span-5">
            <div className="relative group mx-auto max-w-md">
              <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-indigo-500 to-cyan-500 opacity-30 group-hover:opacity-60 blur-xl transition-all duration-300" />
              <div className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 shadow-xl">
                <div className="aspect-[4/5] rounded-xl overflow-hidden relative">
                  <img
                    src={personal.avatar}
                    alt={`${personal.name} working on web development`}
